...
record → migrations 265→273 → verification → naya build upload → smoke
test → Live accepted. **Backup confirm hone se pehle 265–273 Live par
NAHI chalengi.**
...
2. **Rukna** — dono file ke size aayen (backup verified), phir
   pre-migration ginti (section 4 wali), phir main **265–273 Live par
