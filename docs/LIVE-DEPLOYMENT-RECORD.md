...
| **Live par NAHI chalin** | **243 se 257 tak** |
| Testing par | 226 se 257 tak sab |

**243–257 chalne se pehle abhi ka build Live par upload nahi hona
...
243–257 chalne ke **foran baad** wohi das tables dobara ginein aur upar
...
1. **Backup** — do `pg_dump` command (schema + data). Connection string
   ...
   aani.
2. **Rukna** — dono file ke size aayen, phir main **243–257 Live par
