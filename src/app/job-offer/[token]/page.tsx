    ...
    <div className="min-h-screen bg-surface-50 px-4 py-10">
      <div className="mx-auto max-w-md overflow-hidden rounded-2xl border border-surface-200 bg-white shadow-lg">
        <div className="bg-[#1a1f36] px-6 py-6 text-center">
          <p className="font-display text-xl font-bold text-white">Al Rana Traders</p>
          <p className="mt-0.5 text-xs text-slate-400">AgriBridge - Pakistan's Trusted Agriculture Bridge</p>
        </div>

        <div className="p-6">
          <h1 className="font-display text-lg font-semibold text-surface-900">Job Offer</h1>
          ...
          <div className="mt-4 space-y-2 rounded-lg bg-surface-50 p-4 text-sm">
            ...
            {offer.proposed_salary && <p><strong>Proposed Salary:</strong> Rs {Number(offer.proposed_salary).toLocaleString()}</p>}
            {branchName && <p><strong>Shop/Branch:</strong> {branchName}</p>}
