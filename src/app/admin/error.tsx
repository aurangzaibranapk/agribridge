  ...
  return (
    <div className="mx-auto max-w-xl py-12">
      <div className="rounded-card border border-red-200 bg-red-50 p-5 dark:border-red-900/40 dark:bg-red-950/20">
        <h1 className="font-display text-lg font-semibold text-red-800 dark:text-red-300">
          Is safhe par kuch toot gaya
        </h1>
        <p className="mt-1 text-sm text-red-700 dark:text-red-400">
          Aap ka koi kaam zaya nahi hua — jo pehle mehfooz ho chuka tha wo mehfooz hai.
        </p>

        <div className="mt-4 rounded-lg border border-red-200 bg-white p-3 dark:border-red-900/40 dark:bg-surface-900">
          <p className="text-xs font-medium uppercase tracking-wide text-surface-500">Wajah</p>
