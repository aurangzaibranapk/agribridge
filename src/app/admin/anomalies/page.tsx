      ...
      <Card className="p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-1.5 text-xs text-surface-600 dark:text-surface-400">
            <p>
              Baqi safhe wo pakarte hain jahan kisi ne <strong>usool torha</strong>. Ye safha wo dekhta hai
              jahan har usool poora hua aur phir bhi kuch ajeeb hai — jaise wo branch jahan cash ka farq{" "}
              <em>hamesha</em> kam nikalta ho, kabhi zyada nahi. Ginti ki ghalti ittefaqi hoti hai; jo
              cheez hamesha ek hi taraf jhukti ho, wo ittefaq nahi rehti.
            </p>
            <p>
              <strong>Yahan AI istemal nahi hota.</strong> Ye safha naam le kar baat karta hai, aur aisi
            ...
            <p>
              <strong>Ye ilzam nahi, sawal hai.</strong> Aur namoona {MIN_SAMPLE} se kam ho to kuch kaha
      ...
      {open.length === 0 ? (
        <Card className="border-l-4 border-l-green-500 p-4">
          <p className="flex items-start gap-2 text-sm text-green-800 dark:text-green-400">
            ...
            <span>
              Koi ghair-maamooli tarteeb nazar nahi aa rahi.
              <span className="mt-0.5 block text-xs font-normal text-surface-600 dark:text-surface-400">
      ...
      {reviewed.length > 0 && (
        <Card className="overflow-hidden">
          <div className="border-b border-surface-200 px-4 py-3 dark:border-surface-800">
            <h2 className="text-sm font-semibold text-surface-900 dark:text-white">Jo dekhi ja chuki</h2>
