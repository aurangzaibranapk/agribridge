...
export async function loadNav(profileId: string, role: string, lang: Lang = "rm"): Promise<NavResult> {
  ...
  // warna wo banda apne hi system se bahar ho jata hai. (11 September:
  // Anwar Ul Hassan -- role ka template 13 features ka hai, magar us
  // par KHUD kisi ne apply nahi kiya -- v_user_feature_access khali. Ye
  // fallback isi ke liye hai, "unification" ke baad bhi zaroori.)
  if (visible.size === 0) {
