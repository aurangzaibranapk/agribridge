/**
 * Kisan portal ke alfaz.
 *
 * Ye wo hissa hai jo kisan khud parhta hai. Yahan Urdu asal zaban hai
 * aur English mehmaan -- baqi admin panel mein us ka ulta hai.
 *
 * Istilahat ke liye glossary.ts dekhein: ek hi cheez ka ek hi naam har
 * jagah, warna do safhon par do alag lafz aa jate hain aur banda
...
export const portalDict = {
  ...
  will_sell_to_us_q: { en: "Will you sell this crop to us?", ur: "کیا آپ یہ فصل ہمیں بیچیں گے؟" },
  advance_already_paid_q: { en: "I have already paid an advance", ur: "میں ایڈوانس دے چکا ہوں" },
  advance_amount_placeholder: { en: "Amount (Rs)", ur: "رقم (روپے)" },
  advance_reference_placeholder: { en: "Reference / transaction no. (optional)", ur: "ریفرنس / ٹرانزیکشن نمبر (اختیاری)" },
  pay_cash: { en: "Cash", ur: "نقد" },
  pay_bank: { en: "Bank transfer", ur: "بینک ٹرانسفر" },
  pay_wallet: { en: "Mobile wallet (Easypaisa / JazzCash)", ur: "موبائل والٹ (ایزی پیسہ / جاز کیش)" },
  advance_claim_pending_note: {
    en: "Our office will check this and confirm. Until then it does not reduce your bill.",
    ur: "ہمارا دفتر اسے دیکھ کر تصدیق کرے گا۔ تب تک یہ آپ کے بل میں کم نہیں ہوگا۔",
  },
  my_bookings_heading: { en: "My machinery bookings", ur: "میری مشینری بکنگز" },
  farmer_status_new: { en: "Requested — rate awaited", ur: "درخواست بھیج دی — ریٹ کا انتظار" },
  farmer_status_scheduled: { en: "Confirmed — machine scheduled", ur: "تصدیق شدہ — مشین شیڈول" },
  farmer_status_working: { en: "Work in progress", ur: "کام جاری ہے" },
  farmer_status_bill_making: { en: "Work done — bill being made", ur: "کام مکمل — بل بن رہا ہے" },
  farmer_status_payment_due: { en: "Payment due", ur: "ادائیگی باقی" },
  farmer_status_closed: { en: "Settled", ur: "حساب پورا" },
  farmer_status_cancelled: { en: "Cancelled", ur: "منسوخ" },
  rate_label_portal: { en: "Rate", ur: "ریٹ" },
  bill_label_portal: { en: "Bill", ur: "بل" },
  advance_label_portal: { en: "Advance adjusted", ur: "ایڈوانس منہا" },
  paid_label_portal: { en: "Paid", ur: "ادا شدہ" },
  outstanding_label_portal: { en: "Outstanding", ur: "باقی" },
  advance_claim_waiting: {
    en: "Advance you reported, still being checked",
    ur: "آپ کا بتایا ہوا ایڈوانس، ابھی تصدیق ہو رہی ہے",
  },
  ...
  loc_accuracy: { en: "accuracy", ur: "درستگی" },
  loc_manual: { en: "pinned by hand", ur: "ہاتھ سے لگائی گئی" },
  loc_weak_signal: {
    en: "Signal is weak — the point may be off by this much. Stand in the open field and try again, or fix it by hand below.",
    ur: "سگنل کمزور ہے — جگہ اتنی دور ہو سکتی ہے۔ کھلے کھیت میں کھڑے ہو کر دوبارہ کوشش کریں، یا نیچے ہاتھ سے درست کریں۔",
  },
  loc_fix_manually: { en: "Fix the point by hand", ur: "جگہ ہاتھ سے درست کریں" },
  loc_manual_hint: {
    en: "Only use this if GPS is off. A hand-pinned point carries no accuracy reading.",
    ur: "یہ صرف اس وقت استعمال کریں جب GPS غلط ہو۔ ہاتھ سے لگائی گئی جگہ کے ساتھ درستگی کا کوئی پیمانہ نہیں ہوتا۔",
  },
