...
export const productsFlowDict = {
  ...
  pf_th_botal: { en: "Bottles/pack", rm: "Botal (pet)", ur: "بوتل (پیٹ)" },
  pf_th_qty: { en: "Qty", rm: "Kitne Aaye", ur: "کتنے آئے" },
  pf_th_trade: { en: "Trade", rm: "Trade", ur: "ٹریڈ" },
  pf_th_amount: { en: "Amount", rm: "Amount", ur: "رقم" },
  pf_th_sale: { en: "Sale", rm: "Sale", ur: "سیل" },
  pf_th_wholesale: { en: "Wholesale", rm: "Thok", ur: "تھوک" },
  pf_th_mrp: { en: "MRP", rm: "MRP", ur: "ایم آر پی" },
  pf_th_expiry: { en: "Expiry", rm: "Expiry", ur: "میعاد" },
  pf_th_state: { en: "State", rm: "Haalat", ur: "حالت" },
  pf_sum_total: { en: "Total Amount", rm: "Total Amount", ur: "کل رقم" },
  ...
  pf_sum_note: {
    ...
    ur: "رقم = تعداد × ٹریڈ ریٹ۔ ڈسکاؤنٹ/ٹیکس پورے بل کے ہیں اور پرچیز پر محفوظ ہوتے ہیں۔",
  },
  ...
  pf_ps_t_duplicates: { en: "Duplicates", rm: "Duplicate", ur: "ڈپلیکیٹ" },
  pd_all_categories: { en: "All", rm: "Sab", ur: "سب" },

  // ---- Ijazat ki darkhwast (Guided ERP G, 270) ----
  ar_title: { en: "Access Requests", rm: "Ijazat ki Darkhwastein", ur: "اجازت کی درخواستیں" },
  ar_desc: { en: "AI drafts, a person approves, the permission engine applies. Nothing changes until someone here says yes.", rm: "AI draft banata hai, insaan manzoor karta hai, engine lagata hai. Yahan haan hone tak kuch nahi badalta.", ur: "AI ڈرافٹ بناتا ہے، انسان منظور کرتا ہے، انجن لگاتا ہے۔" },
  ar_t_pending: { en: "Pending", rm: "Baqi", ur: "باقی" },
  ...
  // Audit ki qatarein insani zaban mein (kachcha JSON nahi)
  ar_ev_system: { en: "System", rm: "System", ur: "سسٹم" },
  ar_ev_detected: { en: "Conflict detected", rm: "Takraao mila", ur: "ٹکراؤ ملا" },
  ar_ev_resolved: { en: "Conflict cleared", rm: "Takraao khatam hua", ur: "ٹکراؤ ختم ہوا" },
  ar_ev_acknowledged: { en: "Seen and noted", rm: "Dekh liya gaya", ur: "دیکھ لیا گیا" },
  ar_ev_overridden: { en: "Left in place on purpose", rm: "Jaan boojh kar rehne diya", ur: "جان بوجھ کر رہنے دیا" },
  ar_ev_reopened: { en: "Reopened", rm: "Dobara khola gaya", ur: "دوبارہ کھولا گیا" },
  ar_ev_rule_updated: { en: "Rule changed", rm: "Qanoon badla gaya", ur: "قانون بدلا گیا" },
  ar_ev_sod_rule_updated: { en: "Self-approval rule changed", rm: "Khud-manzoori ka qanoon badla", ur: "خود منظوری کا قانون بدلا" },
  ar_ev_scan: { en: "Scan run", rm: "Scan chala", ur: "اسکین چلا" },
  cfl_sev_critical: { en: "critical", rm: "intehai ahem", ur: "انتہائی اہم" },
  cfl_sev_high: { en: "high", rm: "ahem", ur: "اہم" },
  cfl_sev_warning: { en: "warning", rm: "tanbeeh", ur: "تنبیہ" },
  cfl_sev_info: { en: "info", rm: "maloomat", ur: "معلومات" },
  ar_tech: { en: "Technical details", rm: "Technical tafseel", ur: "تکنیکی تفصیل" },
  ar_ev_created: { en: "Request created", rm: "Darkhwast bani", ur: "درخواست بنی" },
  ar_ev_approved_applied: { en: "Approved and applied", rm: "Manzoor ho kar lag gayi", ur: "منظور ہو کر لگ گئی" },
  ar_ev_approved_with_override: { en: "Approved with override", rm: "Override ke sath manzoor", ur: "اوور رائیڈ کے ساتھ منظور" },
  ar_ev_approval_blocked: { en: "Approval blocked by a rule", rm: "Qanoon ne manzoori rok di", ur: "قانون نے منظوری روک دی" },
  ar_ev_rejected: { en: "Rejected", rm: "Radd ki gayi", ur: "رد کی گئی" },
  ar_ev_capped: { en: "Trimmed to the approver's own limit", rm: "Manzoor karne wale ki apni hadd tak kaat di gayi", ur: "منظور کرنے والے کی حد تک" },
  ar_ev_applied_line: { en: "Given: {f} — {a}", rm: "Mila: {f} — {a}", ur: "ملا: {f} — {a}" },
  ar_ev_refused_line: {
    en: "{n} item(s) not given — beyond what the approver holds.",
    rm: "{n} cheez nahi mili -- manzoor karne wale ke apne ikhtiyar se bahar thi.",
    ur: "{n} چیز نہیں ملی",
  },
  ar_ev_conflict_line: { en: "{n} access conflict(s) recorded.", rm: "{n} takraao darj hue.", ur: "{n} ٹکراؤ درج ہوئے۔" },
  ar_ev_expires_line: { en: "Ends on {d}", rm: "Khatam: {d}", ur: "ختم: {d}" },
  ar_ev_note_line: { en: "Note: {t}", rm: "Note: {t}", ur: "نوٹ: {t}" },
  ar_load_failed: {
  ...
  ar_department: { en: "Department", rm: "Department", ur: "ڈیپارٹمنٹ" },
  ar_for: { en: "For", rm: "Kis ke liye", ur: "کس کے لیے" },
  ar_by: { en: "Requested by", rm: "Kis ne maanga", ur: "کس نے مانگا" },
  ar_what: { en: "What", rm: "Kya", ur: "کیا" },
  ar_actions: { en: "Actions", rm: "Kaam", ur: "کام" },
  ar_scope: { en: "Scope", rm: "Daira", ur: "دائرہ" },
  ar_duration: { en: "Duration", rm: "Kab tak", ur: "کب تک" },
  ar_reason: { en: "Reason", rm: "Wajah", ur: "وجہ" },
  ar_ai_read: { en: "What the AI understood", rm: "AI ne kya samjha", ur: "AI نے کیا سمجھا" },
  ar_old_new: { en: "Old → new permissions", rm: "Purani → nayi ijazat", ur: "پرانی → نئی اجازت" },
  ar_trail: { en: "Audit trail (append-only)", rm: "Silsila (sirf jama hota hai, mitta nahi)", ur: "سلسلہ" },
  ar_decide: { en: "Decision", rm: "Faisla", ur: "فیصلہ" },
  ar_head_note: { en: "You can only grant what you hold yourself; anything beyond is cut automatically and recorded.", rm: "Aap sirf wo de sakte hain jo aap ke paas hai; baqi khud kat jata hai aur likha jata hai.", ur: "آپ صرف وہ دے سکتے ہیں جو آپ کے پاس ہے۔" },
  ar_master_note: { en: "Approving applies the permission now; it expires on its own if temporary.", rm: "Manzoor karte hi ijazat lag jati hai; waqti ho to apni miyaad par khud khatam.", ur: "منظور کرتے ہی اجازت لگ جاتی ہے۔" },
  ar_note: { en: "Note (required to reject)", rm: "Note (radd par lazmi)", ur: "نوٹ (رد پر لازمی)" },
  ar_approve: { en: "Approve & apply", rm: "Manzoor karein aur lagayein", ur: "منظور کریں اور لگائیں" },
  ar_reject: { en: "Reject", rm: "Radd karein", ur: "رد کریں" },
  ar_change_toggle: { en: "Change what's granted instead", rm: "Jo diya jaye wo badalna ho", ur: "جو دیا جائے وہ بدلنا ہو" },
  ar_change_actions: { en: "Actions to grant", rm: "Kya kya karne ki ijazat", ur: "کیا کرنے کی اجازت" },
  ar_change_scope: { en: "Scope to grant", rm: "Daaira (scope)", ur: "دائرہ" },
  ar_change_cancel: { en: "Undo change", rm: "Waisa hi rehne dein", ur: "ویسا ہی رہنے دیں" },
  ar_change_approve: { en: "Change & approve", rm: "Badal kar manzoor karein", ur: "بدل کر منظور کریں" },
  ar_staff: { en: "Staff", rm: "Staff", ur: "اسٹاف" },
  ar_expires: { en: "Expires", rm: "Khatam", ur: "ختم" },
  ar_permanent: { en: "permanent", rm: "mustaqil", ur: "مستقل" },
  ar_none_grants: { en: "No per-person grants — everyone runs on role permissions.", rm: "Kisi ko alag se kuch nahi diya — sab role ki ijazat par chal rahe hain.", ur: "کسی کو الگ سے کچھ نہیں دیا۔" },
  ar_who_note: { en: "Role-level permissions are on the Permissions page; this list is per-person extras.", rm: "Role ki ijazatein Permissions safhe par hain; ye fehrist alag se di hui hai.", ur: "رول کی اجازتیں پرمیشنز صفحے پر ہیں۔" },
  ar_none_expiring: { en: "Nothing expiring in the next 7 days.", rm: "Agle 7 din mein kuch khatam nahi ho raha.", ur: "اگلے 7 دن میں کچھ ختم نہیں ہو رہا۔" },
  ar_expiring_note: { en: "Expired access switches off by itself — no one has to remember.", rm: "Miyaad par ijazat khud band ho jati hai — kisi ko yaad nahi rakhna.", ur: "میعاد پر اجازت خود بند ہو جاتی ہے۔" },
  ar_extra: { en: "Extra departments", rm: "Doosre departments", ur: "دوسرے ڈیپارٹمنٹس" },
  ma_title: { en: "My Access", rm: "Meri Ijazatein", ur: "میری اجازتیں" },
  ma_desc: { en: "What you can open and do, what you have asked for, your departments.", rm: "Aap ko kya khulta hai aur kya kar sakte hain, kya maanga hua hai, aap ke department.", ur: "آپ کو کیا کھلتا ہے، کیا مانگا ہوا ہے۔" },
  ma_request: { en: "Request access", rm: "Ijazat maangein", ur: "اجازت مانگیں" },
  ma_request_short: { en: "Access", rm: "Ijazat maangein", ur: "اجازت مانگیں" },
  ma_ask_prefill: { en: "I need access to: ", rm: "Mujhe is ki ijazat chahiye: ", ur: "مجھے اس کی اجازت چاہیے: " },
  ma_mine: { en: "What I can open", rm: "Jo mujhe khulta hai", ur: "جو مجھے کھلتا ہے" },
  ma_none: { en: "Nothing assigned yet — ask the coach.", rm: "Abhi kuch nahi — coach se maangein.", ur: "ابھی کچھ نہیں۔" },
  ma_departments: { en: "My departments", rm: "Mere department", ur: "میرے ڈیپارٹمنٹ" },
  ma_requests: { en: "My requests", rm: "Meri darkhwastein", ur: "میری درخواستیں" },
  ma_no_requests: { en: "None.", rm: "Koi nahi.", ur: "کوئی نہیں۔" },
  ma_cancel: { en: "Withdraw", rm: "Wapas lein", ur: "واپس لیں" },
  ma_revoke: { en: "Request removal", rm: "Khatam karwayein", ur: "ختم کروائیں" },
  ma_revoke_reason: { en: "Reason (optional)", rm: "Wajah (agar likhni ho)", ur: "وجہ (اختیاری)" },
  ma_revoke_send: { en: "Send request", rm: "Darkhwast bhejein", ur: "درخواست بھیجیں" },
  ma_revoke_cancel: { en: "Cancel", rm: "Raho do", ur: "چھوڑیں" },
  ...
  sod_title: { en: "Self-approval on records (transaction-level SoD)", rm: "Apna kaam khud manzoor (transaction-level SoD)", ur: "اپنا کام خود منظور" },
  sod_desc: { en: "Database rule: whoever creates a record cannot approve, verify or receive it. block = stopped; warn = allowed and logged; Owner/Admin exempt but logged.", rm: "Database ka qanoon: jis ne record banaya wohi manzoor, tasdeeq ya receive nahi kar sakta. block = ruk gaya; warn = chal gaya, likha gaya; Owner/Admin exempt magar likha jata hai.", ur: "جس نے ریکارڈ بنایا وہی منظور نہیں کر سکتا۔" },
  sod_events: { en: "Recent events (allowed but logged)", rm: "Haal ke waqiat (chal gaye magar likhe gaye)", ur: "حالیہ واقعات" },
  sod_none: { en: "No self-approval events yet.", rm: "Abhi koi waqia nahi.", ur: "ابھی کوئی واقعہ نہیں۔" },
  sod_rules: { en: "Rules", rm: "Qawaid", ur: "قواعد" },
  sod_make_warn: { en: "Make warn", rm: "Warn karein", ur: "وارن کریں" },
  sod_make_block: { en: "Make block", rm: "Block karein", ur: "بلاک کریں" },
  sod_off: { en: "Turn off", rm: "Band karein", ur: "بند کریں" },
  sod_on: { en: "Turn on", rm: "Chalu karein", ur: "چالو کریں" },
  sod_blocked_note: { en: "Blocked attempts are not stored (the transaction is rolled back); the person sees the SOD message on screen.", rm: "Ruki hui koshishein mehfooz nahi hotin (transaction wapas ho jati hai); banday ko screen par SOD ka paighaam milta hai.", ur: "رکی ہوئی کوششیں محفوظ نہیں ہوتیں۔" },
  ...
  un_edit: { en: "Edit", rm: "Badlein", ur: "بدلیں" },
  un_close: { en: "Close", rm: "Band karein", ur: "بند کریں" },
  un_kind: { en: "Kind", rm: "Qisam", ur: "قسم" },
  un_label: { en: "Label", rm: "Label", ur: "لیبل" },
  un_base: { en: "Base unit", rm: "Base ikai", ur: "بنیادی اکائی" },
  un_factor: { en: "Factor (1 of this = ? base)", rm: "Factor (is ka 1 = kitne base)", ur: "فیکٹر" },
  un_aliases: { en: "Aliases (comma-separated)", rm: "Aliases (comma se alag)", ur: "متبادل الفاظ" },
  un_sort: { en: "Order", rm: "Tarteeb", ur: "ترتیب" },
  un_save: { en: "Save", rm: "Mehfooz karein", ur: "محفوظ کریں" },
  un_active: { en: "Active", rm: "Chalu", ur: "چالو" },
  un_activate: { en: "Activate", rm: "Chalu karein", ur: "چالو کریں" },
  un_deactivate: { en: "Deactivate", rm: "Band karein", ur: "بند کریں" },
  un_delete: { en: "Delete", rm: "Delete", ur: "حذف" },
  un_quantity: { en: "Quantity", rm: "Miqdar", ur: "مقدار" },
  un_alias_note: { en: "Aliases are the words on supplier bills and sheets: bori, thaila, peti, dabba. They are used when matching bill lines to products.", rm: "Aliases wo lafz hain jo supplier ke bill aur sheet par aate hain: bori, thaila, peti, dabba. Bill ki qatar product se milate waqt yehi kaam aate hain.", ur: "متبادل الفاظ وہ ہیں جو بل پر آتے ہیں۔" },
  ps_desc: { en: "Standard pack sizes (5L, 20kg, 500ml) with the ways bills write them. The product form suggests these; matching uses the aliases.", rm: "Standard pack sizes (5L, 20kg, 500ml) aur bill par unke likhne ke tareeqe. Product form yehi sujhata hai; matching aliases istemal karti hai.", ur: "معیاری پیک سائز اور بل پر ان کے لکھنے کے طریقے۔" },
  ps_new: { en: "New pack size", rm: "Naya pack size", ur: "نیا پیک سائز" },
  ps_alias_note: { en: "Example: 5L with aliases \"5 ltr, 5ltr, 5 litre, panch litre\" -- a bill line \"Sufi 5 ltr\" then matches \"Sufi Cooking Oil 5L\".", rm: "Misal: 5L ke aliases \"5 ltr, 5ltr, 5 litre, panch litre\" -- phir bill ki qatar \"Sufi 5 ltr\" catalogue ke \"Sufi Cooking Oil 5L\" se mil jati hai.", ur: "مثال: 5L کے متبادل الفاظ۔" },
  cfl_title: { en: "Access conflicts (Separation of Duties)", rm: "Ijazat ka takraao (Separation of Duties)", ur: "اجازت کا ٹکراؤ" },
  cfl_desc: { en: "Who holds permissions together that should be separate (create + verify + reverse). Report and advice only: nothing is removed here. The decision is yours; the rules are editable.", rm: "Kis ke paas aisi ijazatein ek sath hain jo alag honi chahiyein (banana + tasdeeq + ulta karna). Sirf report aur mashwara: yahan se kuch nahi hatta. Faisla aap ka; qawaid badle ja sakte hain.", ur: "کس کے پاس ایسی اجازتیں ایک ساتھ ہیں جو الگ ہونی چاہئیں۔ صرف رپورٹ، کچھ نہیں ہٹتا۔" },
  cfl_conflict: { en: "Conflict", rm: "Takraao", ur: "ٹکراؤ" },
  cfl_scan: { en: "Run scan", rm: "Scan chalayein", ur: "اسکین چلائیں" },
  cfl_last_scan: { en: "Last scan", rm: "Aakhri scan", ur: "آخری اسکین" },
  cfl_found: { en: "found", rm: "mile", ur: "ملے" },
  cfl_show_all: { en: "Show resolved too", rm: "Khatam shuda bhi dikhayein", ur: "ختم شدہ بھی دکھائیں" },
  cfl_show_open: { en: "Open only", rm: "Sirf khule", ur: "صرف کھلے" },
  cfl_rules: { en: "Rules", rm: "Qawaid", ur: "قواعد" },
  cfl_rules_note: { en: "Rules live in the database, not in code. Owner/Admin can change severity, enforcement, duties and scope here; the next scan follows them.", rm: "Qawaid database mein hain, code mein nahi. Owner/Admin yahin severity, enforcement, duties aur scope badal sakta hai; agla scan usi ke mutabiq hoga.", ur: "قواعد ڈیٹابیس میں ہیں، کوڈ میں نہیں۔" },
  cfl_none: { en: "No open conflicts.", rm: "Koi khula takraao nahi.", ur: "کوئی کھلا ٹکراؤ نہیں۔" },
  cfl_duty: { en: "Duty", rm: "Kaam", ur: "کام" },
  cfl_source: { en: "Source", rm: "Kahan se", ur: "کہاں سے" },
  cfl_first_seen: { en: "First seen", rm: "Pehli dafa", ur: "پہلی بار" },
  cfl_last_seen: { en: "Last seen", rm: "Aakhri dafa", ur: "آخری بار" },
  cfl_until: { en: "until", rm: "tak", ur: "تک" },
  cfl_fix_hint: { en: "To actually separate the permissions, use", rm: "Ijazat asal mein alag karne ke liye", ur: "اجازت الگ کرنے کے لیے" },
  cfl_note: { en: "Note", rm: "Note", ur: "نوٹ" },
  cfl_ack: { en: "Acknowledge", rm: "Dekh liya", ur: "دیکھ لیا" },
  cfl_override: { en: "Override (keep as is)", rm: "Override (rehne dein)", ur: "اوور رائیڈ" },
  cfl_reopen: { en: "Reopen", rm: "Wapas kholein", ur: "دوبارہ کھولیں" },
  cfl_actions_note: { en: "Nothing is removed here. Override = Owner/Admin only, reason mandatory, optional expiry; all of it is logged.", rm: "Yahan se kuch nahi hatta. Override sirf Owner/Admin, wajah lazmi, miyaad ikhtiyari; sab likha jata hai.", ur: "یہاں سے کچھ نہیں ہٹتا۔ اوور رائیڈ صرف اونر/ایڈمن۔" },
  cfl_block_note: { en: "Policy hard block: no override possible. Separate the permissions.", rm: "Policy hard block: override mumkin nahi. Ijazat alag karein.", ur: "پالیسی ہارڈ بلاک: اوور رائیڈ ممکن نہیں۔" },
  cfl_gate_title: { en: "This permission would create an access conflict with existing access", rm: "Is permission se ye existing access conflict create hoga", ur: "اس اجازت سے موجودہ رسائی سے ٹکراؤ بنے گا" },
  cfl_gate_block: { en: "Policy hard block: nobody can approve this combination. Reject, or separate the existing permission first.", rm: "Policy hard block: ye combination koi manzoor nahi kar sakta. Radd karein, ya pehle purani ijazat alag karein.", ur: "پالیسی ہارڈ بلاک: کوئی منظور نہیں کر سکتا۔" },
  cfl_gate_override: { en: "HIGH/CRITICAL: approving needs an override reason (mandatory). Your name, time and expiry are recorded.", rm: "HIGH/CRITICAL: manzoori ke liye override ki wajah lazmi hai. Aap ka naam, waqt aur miyaad likhi jayegi.", ur: "ہائی/کریٹیکل: منظوری کے لیے اوور رائیڈ کی وجہ لازمی۔" },
  cfl_gate_override_head: { en: "HIGH/CRITICAL: only Owner/Admin can override this. Approve is disabled for you.", rm: "HIGH/CRITICAL: sirf Owner/Admin override kar sakta hai. Aap ke liye Approve band hai.", ur: "صرف اونر/ایڈمن اوور رائیڈ کر سکتا ہے۔" },
  cfl_gate_advise: { en: "Advisory: you may approve; the conflict is recorded and shows in the Conflicts tab.", rm: "Advisory: manzoor kar sakte hain; takraao likha jayega aur Takraao tab mein dikhega.", ur: "مشورہ: منظور کر سکتے ہیں، ٹکراؤ لکھا جائے گا۔" },
  cfl_gate_department: { en: "Department assignment grants many features; each is checked on approval and any HIGH/CRITICAL conflict will stop it.", rm: "Department dene se kai features milte hain; manzoori par har ek ki jaanch hogi aur HIGH/CRITICAL takraao rok dega.", ur: "ڈیپارٹمنٹ دینے سے کئی فیچر ملتے ہیں؛ منظوری پر جانچ ہوگی۔" },
  cfl_override_reason: { en: "Override reason", rm: "Override ki wajah", ur: "اوور رائیڈ کی وجہ" },
  cfl_override_expiry: { en: "Override expiry (optional)", rm: "Override ki miyaad (ikhtiyari)", ur: "اوور رائیڈ کی میعاد" },
  cfl_override_note: { en: "The permission will not outlast this expiry.", rm: "Ijazat is miyaad se aage nahi jayegi.", ur: "اجازت اس میعاد سے آگے نہیں جائے گی۔" },
  cfl_overridden_by: { en: "Override", rm: "Override", ur: "اوور رائیڈ" },
  cfl_rule_edit: { en: "Edit rule", rm: "Rule badlein", ur: "قاعدہ بدلیں" },
  cfl_rule_close: { en: "Close", rm: "Band karein", ur: "بند کریں" },
  cfl_rule_desc: { en: "Description", rm: "Tafseel", ur: "تفصیل" },
  cfl_rule_min_scope: { en: "Full severity from scope", rm: "Poori severity is scope se", ur: "پوری شدت اس اسکوپ سے" },
  cfl_rule_narrow: { en: "Narrower scope → severity", rm: "Tang scope par darja", ur: "تنگ اسکوپ پر درجہ" },
  cfl_rule_reco: { en: "Recommendation", rm: "Mashwara", ur: "مشورہ" },
  cfl_rule_active: { en: "Active", rm: "Chalu", ur: "چالو" },
  cfl_rule_save: { en: "Save rule", rm: "Rule mehfooz karein", ur: "قاعدہ محفوظ کریں" },

  // ---- Staff ki tajweezein / Improvements Center (Guided ERP F, 269) ----
  sg_title: { en: "Improvements Center", rm: "Tajweezein aur Masle", ur: "تجاویز اور مسائل" },
  sg_desc: { en: "What staff suggest and report — numbered, never deleted, with full history. Most-reported first.", rm: "Staff jo tajweez aur masle batate hain — number ke sath, kabhi mitte nahi, poori baat mehfooz. Sab se zyada logon wali pehle.", ur: "اسٹاف کی تجاویز اور مسائل — نمبر کے ساتھ، پوری تاریخ محفوظ۔" },
  sg_button: { en: "Suggest improvement", rm: "Tajweez / masla batayein", ur: "تجویز / مسئلہ بتائیں" },
  sg_button_hint: { en: "Tell the coach what should be better; it drafts a suggestion and asks you to confirm.", rm: "Coach ko batayein kya behtar hona chahiye; wo draft banata hai aur aap se tasdeeq leta hai.", ur: "کوچ کو بتائیں کیا بہتر ہونا چاہیے۔" },
  sg_prefill: { en: "Suggestion: ", rm: "Meri tajweez: ", ur: "میری تجویز: " },
  sg_new: { en: "New suggestion", rm: "Nayi tajweez", ur: "نئی تجویز" },
  sg_new_hint: { en: "Prefer telling the Work Coach in your own words — it fills this in for you. This form is the manual way.", rm: "Behtar hai Work Coach ko apne lafzon mein batayein — wo ye khane khud bharta hai. Ye form haath se likhne ka raasta hai.", ur: "بہتر ہے ورک کوچ کو اپنے لفظوں میں بتائیں۔" },
  sg_submitted: { en: "Submitted as {n}.", rm: "{n} ke tor par darj ho gayi.", ur: "{n} کے طور پر درج ہو گئی۔" },
  sg_submit: { en: "Submit", rm: "Darj karein", ur: "درج کریں" },
  sg_open: { en: "Open", rm: "Khuli", ur: "کھلی" },
  sg_all: { en: "All", rm: "Sab", ur: "سب" },
  sg_empty: { en: "Nothing here.", rm: "Yahan kuch nahi.", ur: "یہاں کچھ نہیں۔" },
  sg_f_title: { en: "One-line title", rm: "Ek jumle ka unwaan", ur: "ایک جملے کا عنوان" },
  sg_f_category: { en: "Type", rm: "Qism", ur: "قسم" },
  sg_f_priority: { en: "Priority", rm: "Tarjeeh", ur: "ترجیح" },
  sg_f_feature: { en: "Feature / page", rm: "Feature / safha", ur: "فیچر / صفحہ" },
  sg_f_problem: { en: "Problem", rm: "Masla", ur: "مسئلہ" },
  sg_f_improvement: { en: "Suggested improvement", rm: "Kya hona chahiye", ur: "کیا ہونا چاہیے" },
  sg_f_evidence: { en: "Screenshot / evidence link", rm: "Screenshot / saboot ka link", ur: "اسکرین شاٹ / ثبوت کا لنک" },
  sg_p_low: { en: "Low", rm: "Kam", ur: "کم" },
  sg_p_medium: { en: "Medium", rm: "Darmiyani", ur: "درمیانی" },
  sg_p_high: { en: "High", rm: "Zaroori", ur: "ضروری" },
  sg_s_new: { en: "New", rm: "Nayi", ur: "نئی" },
  sg_s_under_review: { en: "Under review", rm: "Jaanch mein", ur: "جانچ میں" },
  sg_s_accepted: { en: "Accepted", rm: "Manzoor", ur: "منظور" },
  sg_s_planned: { en: "Planned", rm: "Plan mein", ur: "پلان میں" },
  sg_s_in_development: { en: "In development", rm: "Ban rahi hai", ur: "بن رہی ہے" },
  sg_s_implemented: { en: "Implemented", rm: "Ban gayi", ur: "بن گئی" },
  sg_s_rejected: { en: "Rejected", rm: "Radd", ur: "رد" },
  sg_s_duplicate: { en: "Duplicate", rm: "Dohri", ur: "دوہری" },
  sg_c_new_feature: { en: "New feature", rm: "Naya feature", ur: "نیا فیچر" },
  sg_c_improvement: { en: "Improve existing", rm: "Maujooda mein behtari", ur: "موجودہ میں بہتری" },
  sg_c_process: { en: "Process problem", rm: "Kaam ke tareeqe ka masla", ur: "کام کے طریقے کا مسئلہ" },
  sg_c_ui: { en: "UI / usability", rm: "Safha mushkil / UI", ur: "صفحہ مشکل / UI" },
  sg_c_bug: { en: "Bug", rm: "Kharabi (bug)", ur: "خرابی" },
  sg_c_automation: { en: "Automation idea", rm: "Khud-kar (automation)", ur: "خودکار" },
  sg_c_ai: { en: "AI improvement", rm: "AI mein behtari", ur: "AI میں بہتری" },
  sg_c_report: { en: "Report needed", rm: "Report chahiye", ur: "رپورٹ چاہیے" },
  sg_c_training: { en: "Training / help", rm: "Training / madad", ur: "ٹریننگ / مدد" },
  sg_c_other: { en: "Other", rm: "Aur", ur: "اور" },
  sg_reported_by: { en: "reported by {n}", rm: "{n} logon ne bataya", ur: "{n} لوگوں نے بتایا" },
  sg_dup_of: { en: "Duplicate of", rm: "Asal tajweez", ur: "اصل تجویز" },
  sg_related: { en: "Related change", rm: "Mutalliqa tabdeeli", ur: "متعلقہ تبدیلی" },
  sg_version: { en: "Implemented version", rm: "Kis version mein bani", ur: "کس ورژن میں بنی" },
  sg_decide: { en: "Decision", rm: "Faisla", ur: "فیصلہ" },
  sg_status: { en: "Status", rm: "Halat", ur: "حالت" },
  sg_note: { en: "Note to submitter", rm: "Batane wale ke liye note", ur: "بتانے والے کے لیے نوٹ" },
  sg_save_status: { en: "Save decision", rm: "Faisla mehfooz karein", ur: "فیصلہ محفوظ کریں" },
  sg_history: { en: "History", rm: "Silsila", ur: "سلسلہ" },
  sg_comment: { en: "Add", rm: "Likhein", ur: "لکھیں" },
  sg_comment_ph: { en: "Write a comment", rm: "Baat likhein", ur: "بات لکھیں" },
  sg_scope_note: { en: "You see your own suggestions and your department's. Owner/Admin/Manager see everything.", rm: "Aap ko apni aur apne department ki tajweezein dikhti hain. Owner/Admin/Manager sab dekhte hain.", ur: "آپ کو اپنی اور اپنے ڈیپارٹمنٹ کی تجاویز دکھتی ہیں۔" },
  ...
  // Shop ko kya chahiye (280)
  sr_title: { en: "What the shop needs", rm: "Shop ko kya chahiye", ur: "دکان کو کیا چاہیے" },
  sr_desc: {
    en: "From 30 days of sales: what is running out at the shop, and what the warehouse has. A suggestion, not an order.",
    rm: "30 din ki bikri se: shop mein kya khatam ho raha hai, aur godam mein kitna hai. Tajweez hai, hukm nahi.",
    ur: "تیس دن کی بکری سے: دکان میں کیا ختم ہو رہا ہے",
  },
  sr_none: { en: "Nothing is running short right now.", rm: "Abhi kisi cheez ki kami nahi.", ur: "ابھی کسی چیز کی کمی نہیں۔" },
  sr_all_shops: { en: "All shops", rm: "Sab dukanein", ur: "سب دکانیں" },
  sr_c_product: { en: "Product", rm: "Cheez", ur: "چیز" },
  sr_c_shop_stock: { en: "At shop", rm: "Shop mein", ur: "دکان میں" },
  sr_c_daily: { en: "Per day", rm: "Roz", ur: "روز" },
  sr_c_days: { en: "Days left", rm: "Din baqi", ur: "دن باقی" },
  sr_c_warehouse: { en: "Warehouse", rm: "Godam", ur: "گودام" },
  sr_c_send: { en: "Send", rm: "Bhejein", ur: "بھیجیں" },
  sr_u_out: { en: "Out", rm: "Khatam", ur: "ختم" },
  sr_u_critical: { en: "Critical", rm: "Bohat kam", ur: "بہت کم" },
  sr_u_low: { en: "Low", rm: "Kam", ur: "کم" },
  sr_selected: { en: "{n} products selected", rm: "{n} cheezein chuni gayin", ur: "{n} چیزیں چنی گئیں" },
  sr_create: { en: "Create stock request", rm: "Stock darkhwast banayein", ur: "اسٹاک درخواست بنائیں" },
  sr_done: {
    en: "Request created. It now goes through the same approval and dispatch as any other.",
    rm: "Darkhwast ban gayi. Ab wo usi manzoori aur dispatch se guzregi jis se baqi.",
    ur: "درخواست بن گئی",
  },
  sr_one_shop: {
    en: "One request is for one shop. Uncheck the other shop's rows.",
    rm: "Ek darkhwast ek hi dukan ki hoti hai. Doosri dukan ki qatarein sifar kar dein.",
    ur: "ایک درخواست ایک ہی دکان کی ہوتی ہے",
  },
  // Nayi Kharid -- ek darwaza (naqsha 4 September)
  np_title: { en: "New purchase", rm: "Nayi Kharid", ur: "نئی خرید" },
  np_desc: {
    en: "Three ways in. The first is usually the fastest.",
    rm: "Andar aane ke teen raaste. Pehla aksar sab se tez rehta hai.",
    ur: "اندر آنے کے تین راستے",
  },
  np_fastest: { en: "Fastest", rm: "Sab se tez", ur: "سب سے تیز" },
  np_bill_title: { en: "Read the bill with AI", rm: "AI se bill parhwayein", ur: "اے آئی سے بل پڑھوائیں" },
  np_bill_desc: {
    en: "Photo or PDF of the supplier's bill. AI reads the lines, matches products and prepares a draft.",
    rm: "Supplier ke bill ki tasveer ya PDF. AI qatarein parhta hai, product milata hai aur draft taiyar karta hai.",
    ur: "سپلائر کے بل کی تصویر یا پی ڈی ایف",
  },
  np_bill_hint: {
    en: "You check it and send it for approval — nothing is saved on its own.",
    rm: "Aap jaanch kar manzoori ke liye bhejte hain -- khud kuch mehfooz nahi hota.",
    ur: "آپ جانچ کر منظوری کے لیے بھیجتے ہیں",
  },
  np_ai_title: { en: "Just tell the Assistant", rm: "AI ko bol kar", ur: "اے آئی کو بول کر" },
  np_ai_desc: {
    en: "\"ABC company se 50 bori urea aayi hai\" — the Assistant drafts it for you.",
    rm: "\"ABC company se 50 bori urea aayi hai\" -- Assistant draft bana deta hai.",
    ur: "اسسٹنٹ کو بتائیں، وہ ڈرافٹ بنا دے گا",
  },
  np_ai_hint: {
    en: "Bottom-right panel. It drafts; you send.",
    rm: "Neeche daayen kone ka panel. Wo draft banata hai, bhejte aap hain.",
    ur: "نیچے دائیں کونے کا پینل",
  },
  np_manual_title: { en: "Write it by hand", rm: "Haath se likhein", ur: "ہاتھ سے لکھیں" },
  np_manual_desc: {
    en: "No bill in hand, or only a couple of lines — fill the form yourself.",
    rm: "Bill haath mein na ho, ya do hi qatarein hon -- form khud bhar lein.",
    ur: "فارم خود بھر لیں",
  },
  np_manual_hint: {
    en: "Same approval path as the other two.",
    rm: "Manzoori ka raasta wohi hai jo baqi donon ka.",
    ur: "منظوری کا راستہ وہی ہے",
  },
  np_note: {
    en: "Whichever way you start, the purchase is only a document until the goods are counted at the warehouse. Stock moves at receiving, not at approval.",
    rm: "Kisi bhi raaste se shuru karein, purchase sirf kaghaz rehti hai jab tak godam mein maal gina na jaye. Stock manzoori par nahi, receiving par hilta hai.",
    ur: "اسٹاک منظوری پر نہیں، وصولی پر ہلتا ہے",
  },
  ...
  pf_terms_heading: {
    en: "Payment: how much now, how much on credit, and when is it due",
    rm: "Adaigi: abhi kitna diya, kitna udhaar, aur kab dena hai",
    ur: "ادائیگی: ابھی کتنا دیا، کتنا ادھار، اور کب دینا ہے",
  },
