...
export const productsFlowDict = {
  ...
  ac_staff: { en: "Staff", rm: "Staff", ur: "اسٹاف" },
  ac_training_mode: { en: "Training", rm: "Training Mode", ur: "ٹریننگ موڈ" },
  ...
  ac_less: { en: "Hide", rm: "Chhupayein", ur: "چھپائیں" },
  ac_watch: { en: "Watch the video", rm: "Video dekhein", ur: "ویڈیو دیکھیں" },
  ac_no_video: { en: "Video not added yet — the steps below are enough to start.", rm: "Video abhi nahi lagi — neeche ke qadam shuru ke liye kaafi hain.", ur: "ویڈیو ابھی نہیں لگی۔" },
  ac_try: { en: "Try it on the real page", rm: "Asal safhe par try karein", ur: "اصل صفحے پر ٹرائی کریں" },
  ac_ask_q: { en: "explain this to me step by step", rm: "mujhe qadam ba qadam samjhao", ur: "مجھے قدم بہ قدم سمجھاؤ" },
  ac_mark_done: { en: "Mark complete", rm: "Poora ho gaya", ur: "پورا ہو گیا" },
  tm_title: { en: "Training mode", rm: "Training Mode", ur: "ٹریننگ موڈ" },
  tm_welcome: { en: "Welcome, {name}.", rm: "Khush aamdeed, {name}.", ur: "خوش آمدید، {name}۔" },
  tm_dept: { en: "You are in the {dept} department.", rm: "Aap {dept} department mein hain.", ur: "آپ {dept} ڈیپارٹمنٹ میں ہیں۔" },
  tm_your_work: { en: "Your {n} main tasks:", rm: "Aap ke {n} main kaam:", ur: "آپ کے {n} مین کام:" },
  tm_first_step: { en: "Start with the first step", rm: "Pehla qadam kholein", ur: "پہلا قدم کھولیں" },
  tm_no_module: { en: "No training module for your role yet — ask the Work Coach below.", rm: "Aap ke role ka module abhi nahi — neeche Work Coach se poochein.", ur: "آپ کے رول کا ماڈیول ابھی نہیں۔" },
  tm_off: { en: "I know the system — turn training off", rm: "Mujhe system aata hai — training band karein", ur: "مجھے سسٹم آتا ہے — ٹریننگ بند کریں" },
  um_simple: { en: "Simple", rm: "Simple", ur: "سادہ" },
  um_advanced: { en: "Advanced", rm: "Advanced", ur: "ایڈوانسڈ" },
  um_hint: { en: "Simple hides advanced fields; Advanced shows everything. Rules stay the same.", rm: "Simple mein zyada khane chhupe; Advanced mein sab. Rok wahi rehti hai.", ur: "سادہ میں زیادہ خانے چھپے؛ ایڈوانسڈ میں سب۔" },
