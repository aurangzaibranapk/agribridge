...
export const myWorkDict = {
  ...
  mw_subtitle_new: {
    en: "Today's important work and your assigned departments are below.",
    rm: "Aaj ke zaroori kaam aur aap ke department neeche hain.",
    ur: "آج کے ضروری کام اور آپ کے شعبے نیچے ہیں۔",
  },
  ...
  mw_quick_clear: { en: "No urgent work pending today.", rm: "Aaj koi zaroori kaam baqi nahi.", ur: "آج کوئی ضروری کام باقی نہیں۔" },
  mw_quick: { en: "Today's work", rm: "Aaj ka kaam", ur: "آج کا کام" },
  mw_depts: { en: "Your departments", rm: "Aap ke department", ur: "آپ کے شعبے" },
  mw_tools_n: { en: "{n} tasks", rm: "{n} kaam", ur: "{n} کام" },
  mw_need_n: { en: "{n} pending", rm: "{n} baqi", ur: "{n} باقی" },
