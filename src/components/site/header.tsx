...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-emerald-100 bg-white/95 backdrop-blur dark:border-surface-800 dark:bg-surface-950/95">
      <div className="mx-auto flex h-[4.5rem] max-w-[1500px] items-center gap-4 px-4 lg:px-7">
        <Link href="/" className="flex shrink-0 items-center gap-2.5">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-700 to-emerald-500 text-xl font-black text-white shadow-sm">ART</div>
          <div className="hidden sm:block">
            <span className="block text-[10px] font-semibold uppercase tracking-[0.28em] text-surface-500">Al Rana Traders</span>
            <span className="block font-display text-xl font-bold leading-tight text-surface-950 dark:text-white">Agri<span className="text-emerald-700">Bridge</span></span>
          </div>
        </Link>
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          ...
          <Link href="/login" className="rounded-xl bg-emerald-700 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-800">Login</Link>
        </div>
      </div>
    </header>
  );
