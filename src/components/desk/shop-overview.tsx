...
import type { AttentionItem } from "@/lib/access/needs-attention";

/** Caller supplies only the authenticated profile's assigned shop. */
export async function ShopOverview({ shopId, branchId, links, attentionItems }: { shopId: string; branchId: string | null; links: { href: string; label: string }[]; attentionItems: AttentionItem[] }) {
