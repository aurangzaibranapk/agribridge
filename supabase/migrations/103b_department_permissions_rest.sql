-- =====================================================================
-- Migration 103b: Department ki ijazat (103a ke baad chalayein)
-- =====================================================================
-- 103a sirf enum mein 'machinery' shamil karti hai. Ye file us ke baad
-- chalti hai, jab wo value istemal ke qabil ho chuki hoti hai.
