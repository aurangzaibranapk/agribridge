-- =====================================================================
-- AgriBridge — Migration 433: Receipt header par shop ka naam
-- =====================================================================
-- Malik (18 September): receipt ke upar bara/bold header shop ka naam
-- ho ("KISAAN KARYANA MAHABALI"), aur chhote font mein neeche branch
-- ka naam ("MAIN BRANCH") -- abhi sirf branch ka naam akela dikh raha
-- tha ("Main Branch Mahabali"), shop ka naam kahin nahi tha.
--
-- `get_sale_receipt` mein `shop_name` (shops.name, shop sale ke liye)
-- alag se add kiya -- `seller_name` (branch/dealer) jaisa hi tha,
-- chheda nahi taake dealer receipts par koi asar na pare.
