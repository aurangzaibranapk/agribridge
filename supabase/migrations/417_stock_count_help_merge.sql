-- =====================================================================
-- AgriBridge — Migration 417: Stock Count help — duplicate merge
-- =====================================================================
-- Malik: ginti ke dauran duplicate product dikhe to us ko asal naam
-- mein "milane" ki tajweez bhi bhej sakte hain (416). Help text update.
